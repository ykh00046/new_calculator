"""
Normal blend 테스트 (Multiply 블렌드 → Normal 블렌드 변경 후)
"""
import os
import sys
...
def test_normal_blend():
    print("=" * 60)
    print("Normal Blend Test - 서명 밝기 개선 테스트")
    print("=" * 60)
    ...
    signed_image_path = os.path.join(output_dir, "signed_normal_blend.png")
    ...
    print("\n엑셀 파일을 열어서 G2 셀의 서명 색상을 확인하세요.")
    print("Normal blend 사용으로 파란색 서명이 더 밝게 나타나야 합니다.")
